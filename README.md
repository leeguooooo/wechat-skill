...
> **支持微信最新版**:WeChat 4.1.9 ✓ — 同时兼容 4.0.1.52 / 4.1.8。Tencent 热更后 profile API 推送适配,**无需重发 release**。
...
- **平台**:macOS Apple Silicon。**最新支持 WeChat 4.1.9**;同时兼容 4.0.1.52 / 4.1.8。`wechat init` 自动按版本适配。Tencent 热更后 server-side profile 推送新版本适配,**无需重发 release**
